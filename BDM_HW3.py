...
res3 = res2.filter(res2.Count_comp >= 1).groupBy('year', 'Product').agg(func.count('Count_comp').alias('Count_comp_more')).sort('year','Product').select('Product','year','Count_comp','Count_comp_more')
