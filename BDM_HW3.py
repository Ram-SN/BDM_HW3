...
res3 = res2.groupBy('year', 'Product').agg(func.sum('count(res2.Count_comp)').alias('Total Complaints'), func.countDistinct('Company').alias('Total Companies'), func.max('count(Count_comp)').alias('maximum'))
